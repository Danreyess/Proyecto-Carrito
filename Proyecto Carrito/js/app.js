//Variables
//querySelector es para encontrar un elemento en html
const carrito = document.querySelector('#carrito');
const contenedorCarrito = document.querySelector('#lista-Carrito-tb');
...
function leerDatosCurso(curso) {
    ...
    if (existe) {
        ...
        //Agregamos elementos al Array de carrito
...
function carritoHtml() {
    ...
    //Recorre el carrito y genero el HTML
